(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof this['@emotion/css'] === 'undefined') {
      throw new Error("Error loading module 'untitled'. Its dependency '@emotion/css' was not found. Please, check whether '@emotion/css' is loaded prior to 'untitled'.");
    }
    if (typeof this['kotlin-kotlin-stdlib-js-ir'] === 'undefined') {
      throw new Error("Error loading module 'untitled'. Its dependency 'kotlin-kotlin-stdlib-js-ir' was not found. Please, check whether 'kotlin-kotlin-stdlib-js-ir' is loaded prior to 'untitled'.");
    }
    if (typeof this['kotlin-wrappers-kotlin-react-js-ir'] === 'undefined') {
      throw new Error("Error loading module 'untitled'. Its dependency 'kotlin-wrappers-kotlin-react-js-ir' was not found. Please, check whether 'kotlin-wrappers-kotlin-react-js-ir' is loaded prior to 'untitled'.");
    }
    if (typeof this['kotlin-wrappers-kotlin-react-dom-js-ir'] === 'undefined') {
      throw new Error("Error loading module 'untitled'. Its dependency 'kotlin-wrappers-kotlin-react-dom-js-ir' was not found. Please, check whether 'kotlin-wrappers-kotlin-react-dom-js-ir' is loaded prior to 'untitled'.");
    }
    root.untitled = factory(typeof untitled === 'undefined' ? {} : untitled, this['react-dom/client'], react, this['@emotion/css'], this['kotlin-kotlin-stdlib-js-ir'], this['kotlin-wrappers-kotlin-react-js-ir'], this['kotlin-wrappers-kotlin-react-dom-js-ir']);
  }
  ...
  var THROW_ISE = kotlin_kotlin.$_$.i;
  ...
  function Welcome$lambda($this$FC, props) {
    ...
    tmp$ret$3 = tmp$ret$2;
    var tmp = tmp$ret$3;
    $this$FC.z(tmp, Welcome$lambda$lambda(name$delegate));
    var tmp$ret$7;
    ...
    tmp$ret$7 = tmp$ret$6;
    var tmp_0 = tmp$ret$7;
    $this$FC.z(tmp_0, Welcome$lambda$lambda_0(name$delegate));
    return Unit_getInstance();
  }
  ...
  function Welcome$lambda$lambda($name$delegate) {
    return function ($this$invoke) {
      ...
      $this$invoke.y('Hello, ' + invoke$lambda($name$delegate));
      return Unit_getInstance();
    };
  }
